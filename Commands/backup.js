...
module.exports = class backup {
    ...
    async run(client, message, args) {
        try{
            ...
            [Support][https://discord.gg/cVMjC3rrdd]`)
            .setColor("#a11616")
             ...
             await   message.guild.roles.filter(r => r.name !== message.guild.member(client.user.id).highestRole.name).forEach(r => {
                    if (r.comparePositionTo(message.guild.member(client.user.id).highestRole) > 0){
                        let havnthighest = new RichEmbed()
                            ...
                            .setDescription(`Alperen Bot Rolü Sunucudaki En Yüksek Rol Değildir, Bu Yedeği Yüklerken Bazı Hatalara Neden Olabilir!
                ...
                .setDescription("Yedek oluşturma ... Lütfen bekle")
            ...
            save();
                ...
                .setTitle(`${info}  Bilgi`)
                .setDescription(`Yedeği oluşturuldu **${message.guild.name}** Yedek kimliği ile\`${id}\``)
...
\`\`\`-backup info ${id}\`\`\``)
        ...
        m.edit(resultPublic)
            ...
            if(args[1] === "delete") {
                ...
                .setTitle(`${error}  Hata`)
                .setDescription(`Backup_id bağımsız değişkenini tanımlamayı unuttunuz. Daha fazla bilgi için -help yedekleme yükünü kullanın
[Support][https://discord.gg/cVMjC3rrdd]`)
                .setColor("#a11616")
                ...
                .setTitle(`${error}  Hata`)
                .setTitle(`Kimliğine sahip yedeğiniz yok ${code}.`)
                .setDescription(`
[Support][https://discord.gg/cVMjC3rrdd]`)
                .setColor("#a11616")
                ...
                let deletedsuc = new RichEmbed()
                    ...
                    .setDescription(`Başarıyla ** yedekleme silindi **`)
                    .setColor("#59C57B")
...
[Support][https://discord.gg/cVMjC3rrdd]`)
                ...
                .setTitle(`${error}  Hata`)
                .setTitle(`Kimliğine sahip yedeğiniz yok ${code}.`)
                .setDescription("[Support][https://discord.gg/cVMjC3rrdd]")
                .setColor("#a11616")
                if(!backups[message.author.id][code]) return message.channel.send(cantfindbackup)
                
                message.guild.channels.forEach(channel => {
                    channel.delete('Yedeği Yüklemek İçin')
                })

                message.guild.roles.filter(role => role.members.every(member => !member.user.bot)).forEach(role => {
                    role.delete('Yedeği Yüklemek İçin')
                })
            ...
            if(args[1] === "info") {
                ...
                .setTitle(`${error}  Hata`)
                    .setDescription(`Argümanı tanımlamayı unuttunuz **backup_id**. Use \`-help backup info\` daha fazla bilgi için 
                    [Support][https://discord.gg/cVMjC3rrdd]`)
                .setColor("#a11616")
                ...
                .setTitle(`${error}  Error`)
                .setDescription(`İd ile ** yedeğiniz yok ** \`${id}\`.
                "[Support][https://discord.gg/cVMjC3rrdd]`)
                .setColor("#a11616")
            ...
            if(args[1] === "purge") {
              let errorEmbed = new RichEmbed()
              .setTitle(`${error}  Error`)
              .setDescription(`Henüz herhangi bir sunucuyu yedeklemediniz
[Support][https://discord.gg/cVMjC3rrdd]`)
                .setColor("#a11616")
...
__This cannot be undone!__`)
                message.channel.sendEmbed(warningEmbed).then(msg => {
                    ...
                    yes.on("collect", r => {
                        ...
                        let deletedsuc = new RichEmbed()
                            .setTitle(`${green}  Voila!`)
                            .setDescription(`Tüm yedeklemelerinizi sildiniz`)
                            .setColor("#59C57B")
                        message.channel.send(deletedsuc)
                      msg.delete();
                    })
